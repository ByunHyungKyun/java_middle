...
public class T16_LockAccountTest {
	 ...
	 * 			위해 사용됨. =>(Synchronized를 이용한 동기화 처리보다 부가적인 기능이 제공됨 ) ex: Fairnexx설정등
	 * 
	...
	public static void main(String[] args) {
		...
		BankThread2 byh2 = new BankThread2(lAcc);
...
class LockAccount {
	...
	//출금 처리 메서드(출금성공: true , 출금실패 : false )
	public boolean withdraw(int money) {
		...
		try {
			if(balance >= money){
				for (int i = 0; i <=1000000000; i++) {} //시간떄우기
				balance -= money;
