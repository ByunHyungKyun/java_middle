...
public class T01_FileTest {
	public static void main(String[] args) throws IOException {
		...
		System.out.println(file3.getName()+"의 용령 크기: "+file.length()+"bytes");
		
		//3. new File(String parent,String child)
		File file4 = new File("d:/D_Other","test.txt");
		System.out.println("절대 경로: "+file4.getAbsolutePath());
		System.out.println("경로: "+file4.getPath());
		System.out.println("표준 경로: "+file4.getCanonicalPath());//이걸쓰면 예외가 발생한다 //최종목적지를 찾아간다
		 ...
		 * 	=> 위두 메서드 모두 만들기를 성공하면 true, 실패하면 false 반환
		 */
